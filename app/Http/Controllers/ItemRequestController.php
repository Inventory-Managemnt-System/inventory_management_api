...
class ItemRequestController extends Controller
{
    ...
    public function qa(): JsonResponse
    {
        ...
        $requests = ItemRequest::with('item', 'school')->whereIn('school_id', $schoolIds)->orWhereIn('location_id', $locationIds)->get();
    ...
    {
        $itemRequest = $this->validate($request, [
            "quantity_given" => "required|numeric",
            "status" => "required|string",
        ]);
    ...
    public function resource(Model $model): array
    {
        return [
            ...
            "item" => [
                ...
                "quantity_issued" => $model['item']['quantity_given'],
